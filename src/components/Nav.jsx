...
export default function Nav({setProfile, setPage, setShowToTweet}) {
    ...
    return (
        <div className='h-screen w-full flex flex-col justify-between items-start border-r border-gray-200'>
            ...
            <button className='flex border-b border-gray-200 hover:bg-gray-200 rounded-full p-4' title='Notifications' onClick={() => { setPage("notifications"); setFocus("notifications") }}>
                <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
